...
parser.add_argument("-e", help="Max Number of epochs", default=100, type=int)
parser.add_argument("-ge", help="Max Global epochs", default=10, type=int)
parser.add_argument("-le", help="Local epochs", default=10, type=int)
